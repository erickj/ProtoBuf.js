...
a.prototype.build=function(b){if(this.clazz&&!b)return this.clazz;b=function(b,f){var a=f.getChildren(h.Message.Field),c=function(f,c){b.Builder.Message.call(this);var d,n;for(d=0;d<a.length;d++)n=a[d],this[n.name]=n.repeated?[]:null;for(d=0;d<a.length;d++)if(n=a[d],"undefined"!=typeof n.options["default"])try{this.set(n.name,n.options["default"])}catch(e){throw Error("[INTERNAL] "+e);}if(1!=arguments.length||"object"!=typeof f||"function"==typeof f.encode||b.Util.isArray(f)||f instanceof p||f instanceof
ArrayBuffer||b.Long&&f instanceof b.Long)for(d=0;d<arguments.length;d++)d<a.length&&this.set(a[d].name,arguments[d]);else for(n=Object.keys(f),d=0;d<n.length;d++)this.set(n[d],f[n[d]])};c.prototype=Object.create(b.Builder.Message.prototype);c.prototype.add=function(a,c){var d=f.getChild(a);if(!d)throw Error(this+"#"+a+" is undefined");if(!(d instanceof b.Reflect.Message.Field))throw Error(this+"#"+a+" is not a field: "+d.toString(!0));if(!d.repeated)throw Error(this+"#"+a+" is not a repeated field");
